...
class Level:
    def __init__(self):
        ...
        self.setup() # must create groups above this function call
    ...
    def setup(self):
        ...
        # house
        for layer in ['HouseFloor', 'HouseFurnitureBottom']:  # house floor is only on bottom because its first
        ...
        # trees (self.all_sprites needs to be the first group)
