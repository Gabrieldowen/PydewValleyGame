        ...
        for index_row, row in enumerate(self.grid):
            for index_col, cell in enumerate(row):
                if 'X' in cell:
                    ...
                    if all((t, b)) and not any((l, r)): tile_type = 'tb'

                    # corners
                    if all((l, b)) and not any((t, r)): tile_type = 'tr'
                    if all((r, b)) and not any((t, l)): tile_type = 'tl'
                    if all((l, t)) and not any((b, r)): tile_type = 'br'
                    if all((r, t)) and not any((b, l)): tile_type = 'bl'
